/**
 * Sanctuary 2D screen (the original Sanctuary tab MVP, moved verbatim from
 * app/(tabs)/sanctuary.tsx for the 3D work -- ADR 0011).
 *
 * This screen is PERMANENT: it is the error-boundary fallback, the low-end
 * degradation floor, the screen-reader default, and the kid-facing "Simple
 * view" for the 3D diorama. Do not delete it when 3D lands.
 *
 * Stylized diorama built from React Native primitives -- no art assets.
 * All copy comes from authored content via GET /v1/sanctuary/me (PR #100).
 * The client never fabricates a Sanctuary unlock; this surface is read-only.
 *
 * Safety posture:
...
export default function Sanctuary2DScreen() {
