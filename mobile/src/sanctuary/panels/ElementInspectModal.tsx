/**
 * Tap-to-inspect modal for Sanctuary elements. Shared by the 2D screen
 * (chip taps) and the 3D diorama (raycast taps) so both surfaces render
 * identical authored content -- extracted from the original
 * app/(tabs)/sanctuary.tsx unchanged.
 */
