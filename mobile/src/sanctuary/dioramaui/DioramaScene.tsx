 ...
 * canvas subtree; the parent unmounts it after the first pulse.
 */
function FirstFramePulse({ onFirstFrame }: { onFirstFrame: () => void }) {
...
/** Light cue card for a silhouette tap: authored title/detail only. */
function CueCard({
  cue,
  onClose,
}: {
