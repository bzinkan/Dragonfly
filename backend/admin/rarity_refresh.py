...
`HINTERLAND_INAT_OAUTH_TOKEN` (with `DRAGONFLY_*` fallback still accepted
during transition). Without an iNat token the calls 401 and every region
is skipped -- safe but useless.
"""
